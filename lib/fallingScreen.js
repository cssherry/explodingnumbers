(function(){
  ...
  GameView.prototype.loses = function () {
    ...
    this.ctx.fillText("Game Over", posX * 0.9, posY);
    this.ctx.strokeText("Game Over", posX * 0.9, posY);
    this.ctx.font="20px Arial";
    this.ctx.fillText("Click Anywhere to Play again.", posX * 0.9, posY + 40);
    this.ctx.strokeText("Click Anywhere to Play again.", posX * 0.9, posY + 40);
