(function(){
  ...
  var Equation = ExplodingNumbers.Equation = function(difficulty){
  ...
  Equation.prototype.createEquation = function(hashOfNumbers) {
    ...
    try {
      ...
      case '+':
        ...
        this.equation = this.createEquation(equationText);
        break;
      case "-":
      ...
      case '*':
        ...
        equationText = multiplicand + ' * ' + multiplier;
        this.equation = this.createEquation(equationText);
        break;
      case '/':
  ...
  Equation.prototype.createEquation = function (text) {
